...
function Ternary() {
  ...
  // Index 2 = Frontend Frameworks; Index 0 = Frontend Framework Overview
      ...
      <main className="fundamentals-main">
        <div className="content-container">
          ...
          <section className="main-content">
            ...
            <p className="page-subtitle">Mastering Modern UI Frameworks</p>
                  ...
                  <div className="content-body">
                      ...
                      <section className="content-section">
                        ...
                        {getContent().code1 && (
                          <div className="code-container">
                            <div className="code-header"><span>JavaScript</span></div>
                    ...
                    {getContent().title4 && (
                      <section className="content-section">
                        ...
                        {getContent().code2 && (
                          <div className="code-container">
                            <div className="code-header"><span>{getContent().result}</span></div>
                    ...
                    {getContent().title5 && (
                      <section className="content-section">
                        ...
                        {getContent().code3 && (
                          <div className="code-container">
                             <div className="code-header"><span>{getContent().result1}</span></div>
                    ...
                    {getContent().title6 && (
                      <section className="content-section">
                        ...
                        {getContent().code4 && (
                          <div className="code-container">
                             <div className="code-header"><span>{getContent().result2}</span></div>
