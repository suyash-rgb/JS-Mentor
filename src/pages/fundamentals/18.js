                        ...
                        {getContent().code1 && (
                          <div className="code-container">
                            <div className="code-header">
                              ...
                              <button
                                onClick={() =>
                                  copyToClipboard(getContent().code1)
                                }
                              >
                                {copied ? "Copied!" : "Copy"}
                              </button>
                        ...
                        {getContent().code2 && (
                          <div className="code-container">
                            <div className="code-header">
                              ...
                              <button
                                onClick={() =>
                                  copyToClipboard(getContent().code2)
                                }
                              >
                                {copied ? "Copied!" : "Copy"}
                              </button>
                        ...
                        {getContent().code4 && (
                          <div className="code-container">
                            <div className="code-header">
                              ...
                              <button
                                onClick={() =>
                                  copyToClipboard(getContent().code4)
                                }
                              >
                                {copied ? "Copied!" : "Copy"}
                              </button>
                        ...
                        {getContent().code5 && (
                          <div className="code-container">
                            <div className="code-header">
                              ...
                              <button
                                onClick={() =>
                                  copyToClipboard(getContent().code5)
                                }
                              >
                                {copied ? "Copied!" : "Copy"}
                              </button>
