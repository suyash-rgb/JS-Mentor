            ...
            >
                ...
                <DialogActions className={`px-5 py-4 border-t border-slate-100 ${isMobile ? 'flex flex-col gap-2' : ''}`}>
                    ...
                    <Button
                        ...
                        className={`font-semibold normal-case shadow-none px-6 w-full sm:w-auto py-2.5 sm:py-1.5 rounded-xl ${!sessionIdInput ? 'bg-slate-100 text-slate-400' : 'bg-red-600 hover:bg-red-700'
                            }`}
                    >
                        Launch Call
                    </Button>
