      ...
      <main className="fundamentals-main">
        <div className="content-container">
          ...
          <section className="main-content">
            ...
            <p className="page-subtitle">Server-Side JavaScript Mastery</p>
              ...
              <div className="content-wrapper">
                <div className="content-card">
                  ...
                  <div className="content-body">
                      ...
                      <section className="content-section">
                        ...
                        {getContent().code1 && (
                          <div className="code-container">
                            <div className="code-header"><span>JavaScript (Node.js)</span></div>
                    ...
                    {/* Section 3: Node.js Modules Overview */}
                    {getContent().title3 && (
                      <section className="content-section">
                        ...
                        {getContent().code2 && (
                          <div className="code-container">
                            <div className="code-header">
                                <span>Example: CommonJS Syntax</span>
                ...
                <div className="compiler-section-wrapper">
                  {!showCompiler ? (
                    <div className="practice-cta">
                      <h3>Ready to run code on the server?</h3>
