...
## Anti-Cheat Proctoring Engine Reference

This section provides a comprehensive technical overview of the **Anti-Cheat Proctoring Engine** implemented in the JS-Mentor platform. It outlines the core detection mechanics, details browser-specific AI sidebar handling, analyzes potential edge cases, and provides recommendations for future security enhancements.

For a standalone copy of this reference, view:
👉 **[Anti-cheat proctoring engine.md](Anti-cheat%20proctoring%20engine.md)**
...
*   [`src/pages/FinalExamPage.js`](./src/pages/FinalExamPage.js) (Manages active exam portal and triggers fullscreen)
*   [`src/pages/LearningPathTopic.js`](./src/pages/LearningPathTopic.js) (Triggers fullscreen for graded coding challenges)
*   [`src/components/common/ExerciseCompiler.js`](./src/components/common/ExerciseCompiler.js) (Monaco paste interception and unmount fullscreen cleanup)
*   [`src/hooks/useAntiCheat.js`](./src/hooks/useAntiCheat.js) (Tab visibility, window focus, custom key blocking, multi-screen detection, and zero-tolerance console execution traps)
